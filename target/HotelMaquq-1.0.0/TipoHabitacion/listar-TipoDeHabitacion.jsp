...
<html>
    ...
    <body>
        ...
        <div class="container d-flex justify-content-center">
            <h1 class="display-5 text-center color-titulo">Tipo de Habitaciones</h1>
        </div>
                    ...
                    <table class="table-striped custom-table">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="th-header" style="background-color: #00382b; color: #ffffff;">Tipo de Habitación</th>
                                <th scope="col" class="th-header" style="background-color: #00382b; color: #ffffff;">Descripción</th>
                                <th scope="col" class="th-header" style="background-color: #00382b; color: #ffffff;">Capacidad</th>
                                <th scope="col" class="th-header" style="background-color: #00382b; color: #ffffff;">Tamaño</th>
                                <th scope="col" class="th-header" style="background-color: #00382b; color: #ffffff;">No. Camas</th>
                                <th scope="col" class="th-header" style="background-color: #00382b; color: #ffffff;">Precio Base</th>
                            </tr>
                        </thead>
                        <tbody>
                            <!-- Bucle para insertar los datos en una nueva fila -->
                            <c:forEach var="TipoDeHabitacion" items="${TipoDeHabitacion}">
                                <tr>
                                    <td>${TipoDeHabitacion.idTipoDeHabitacion}</td>
                                    <td>${TipoDeHabitacion.nombreTipoDeHabitacion}</td>
                                    <td>${TipoDeHabitacion.descripcion}</td>
                                    <td>${TipoDeHabitacion.capacidad}</td>
                                    <td>${TipoDeHabitacion.tamañoEnMetrosCuadrados}</td>
                                    <td>${TipoDeHabitacion.numeroDeCamas}</td>
                                    <td>${TipoDeHabitacion.precioBase}</td>
                                </tr>
                            </c:forEach>
                        </tbody>
                    </table>
