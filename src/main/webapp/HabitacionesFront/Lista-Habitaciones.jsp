...
<html>
    ...
    <body>
        ...
        <div class="container d-flex justify-content-center">
            <h1 class="display-5 text-center color-titulo">Habitaciones</h1>
        </div>
        <div class="container mt-5">
            <div class="row">
                    ...
                    <table class="table-striped custom-table">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="th-header" style="background-color: #00382b; color: #2d8570;">NO. Habitación</th>
                                <th scope="col" class="th-header" style="background-color: #00382b; color: #2d8570;">Precio por Noche</th>
                                <th scope="col" class="th-header" style="background-color: #00382b; color: #2d8570;">ID Tipo de Habitación</th>
                            </tr>
                        </thead>
                        <tbody>
                            <!-- Bucle para insertar los datos en una nueva fila -->
                            <c:forEach var="Habitaciones" items="${Habitaciones}">
                                <tr>
                ...
                <!-- Boton que se dirige al formulario Habitaciones -->
