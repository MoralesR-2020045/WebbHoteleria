    ...
    <body> 
        <nav class="navbar navbar-expand-lg"> <!-- Barra de navegación principal -->
            <div class="container-fluid"> <!-- Contenedor fluido para la barra de navegación -->
                ...
                <div id="myOffcanvas" class="offcanvas"> <!-- Menú lateral (offcanvas) -->
                    <ul class="navbar-nav"> <!-- Lista de elementos del menú lateral -->
                        <li><a class="nav-link" href="#">Huéspedes</a></li> <!-- Enlace a Huéspedes -->
                        <li><a class="nav-link" href="#">Servicios</a></li> <!-- Enlace a Servicios -->
                        <li><a class="nav-link" href="#">Empleados</a></li> <!-- Enlace a Empleados -->
                        <li><a class="nav-link" href="#">Habitaciones</a></li> <!-- Enlace a Habitaciones -->
                        <li><a class="nav-link" href="#">Tipo de Habitación</a></li> <!-- Enlace a Tipo de Habitación -->
                        <li><a class="nav-link" href="#">Reservas</a></li> <!-- Enlace a Reservas -->
                    </ul>
                </div>
            </div>
        </nav>
            ...
            <form action="../../HotelMaquq/empleados-servlet" method="POST" enctype="multipart/form-data"> <!-- Formulario con acción a un servlet -->
                ...
                <div class="row g-3 align-items-center"> <!-- Fila para el campo de contraseña -->
                    ...
                    <div class="col-auto"> <!-- Columna para el campo de entrada de contraseña -->
                        <input type="password" id="inputPassword6" class="form-control" name="contraseñaEmpleado" aria-describedby="passwordHelpInline"> <!-- Campo de entrada de contraseña -->
                    </div>
                ...
                <br> <!-- Espaciador -->
                <div>
                    <input class="btn btn-outline-success" type="submit" value="Agregar"> <!-- Botón de envío para el formulario -->
                </div>
            </form>
        </div>
