...
<html lang="es">
    ...
    <body>
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu color-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <li><a class="dropdown-item" href="./Reservaciones-JSP/Lista-Reservaciones.jsp">Reservas Lista</a></li>
                                    <li><a class="dropdown-item" href="./Reservaciones-JSP/Formulario-Reservaciones.jsp">Reservas</a></li>
                                </ul>
                            </li>
                            <li class="nav-item">
        ...
        <section class="section">
            <div class="text">
                <h2 class="color-titulos">Hotel Coraz�n del Mundo Maya</h2>
                <p>Hotel Maquq es un oasis de lujo y confort en el coraz�n de Guatemala, en donde enriquezemos la
                    cultura gutemalteca, ofreciendo una experiencia �nica para aquellos que buscan un alojamiento 
            ...
            <div class="image">
                ...
                <script>
                    document.addEventListener('DOMContentLoaded', function () {
                        const images = ['imagenHotel3.jpeg', 'imagenHotel4.jpeg', 'imagenHotel14.jpeg']; // Lista de nombres de im�genes
        ...
        <section class="section">
            <div class="image">
                ...
                <script>
                    document.addEventListener('DOMContentLoaded', function () {
                        const images = ['imagenHotel5.jpeg', 'imagenHotel6.jpeg', 'imagenHotel7.jpeg']; // Lista de nombres de im�genes
                        let currentImageIndex = 0;
                        const interval = 3000;
            ...
            <div class="text">
                ...
                <p>Nuestro restaurante en el Hotel Maquq celebra la rica diversidad culinaria de Guatemala, ofreciendo platos tradicionales elaborados con ingredientes frescos y locales. Los hu�spedes pueden disfrutar de una experiencia gastron�mica �nica en un ambiente elegante y acogedor, complementado por un servicio excepcional y una cuidada selecci�n de vinos y c�cteles.</p>
            </div>
        </section>
        ...
        <section class="section" id="servicios">
            <div class="text">
                ...
                <p>Nuestros servicios y comodidades est�n dise�ados para satisfacer las necesidades y superar las expectativas de nuestros hu�spedes. Desde habitaciones lujosas y bien equipadas hasta un spa rejuvenecedor y espacios para eventos vers�tiles, en el Hotel Maquq encontrar�s todo lo necesario para una estad�a c�moda y placentera.</p>
                <div class="square-button .btn-cambio-color">
                    <a href="#" class="btn btn-primary btn-lg">Ver m�s</a>
                </div>
            </div>
            <div class="image">
        ...
        <section class="section" id="eventos">
            ...
            <div class="text">
                ...
                <p>Ya sea que est�s organizando una conferencia, una boda o cualquier otro evento especial, el Hotel Maquq ofrece espacios elegantes y servicios personalizados para garantizar el �xito de tu ocasi�n especial. Nuestro equipo de eventos est� dedicado a hacer realidad tus sue�os, desde la planificaci�n hasta la ejecuci�n, asegurando que cada detalle sea perfecto.</p>
                <div class="square-button .btn-cambio-color">
                    <a href="#" class="btn btn-primary btn-lg">M�s Informaci�n</a>
                </div>
            </div>
        </section>
        ...
        <section class="section section-ubicacion" id="Ubicacion">
            <div class="text">
                <h1 class="color-titulos">Ubicaci�n Maq'u'q</h1>
                <p class="color-texto">10-27 Carretera Quetzal, Ciudad de Guatemala</p>
                <div class="square-button .btn-cambio-color">
                    <a href="https://www.google.com/maps/place/Fundaci%C3%B3n+Kinal/@14.6257364,-90.538503,17z/data=!3m1!4b1!4m6!3m5!1s0x8589a1e448821921:0xf0a2a940ad91e241!8m2!3d14.6257312!4d-90.5359281!16s%2Fg%2F11hh9d7m7t?entry=ttu" class="btn btn-primary btn-lg">�Como Llegar?</a>
                </div>
            </div>
            <div class="image">
        ...
        <section class="section section-contacto" id="contacto">
            <div class="text">
                ...
                <p class="color-texto">Horarios de Atenci�n: 8AM a 3PM</p>
            </div>
            <div class="image">
