    ...
    <head>
        ...
        <style>
            body {
                ...
                background: #ececec;
                background-image: url('../Assets/Image/fondoLogin.png');
                ...
                <div class="col-md-6 right-box">
                    <div class="row align-items-center">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" class="form-control form-control-lg bg-light fd-6" placeholder="Email">
                        </div>
                        <div class="input-group mb-3">
                            <input type="password" class="form-control form-control-lg bg-light fd-6" placeholder="Contraseña">
                        </div>
                        <div class="input-group mb-3">
                            <button class="btn btn-lg btn-primary w-100 fs-5" style="background-color:#2d8570; color:#00221a; border-radius: 10px;">Iniciar Sesión</button>
                        </div>
                        <div class="input-group mb-3">
                            <button class="btn btn-lg btn-light w-100 fs-5" style="border: 2px solid #0F5746; border-radius: 10px; color:#00221a;"><img src="../Assets/Image/logoGoogle.png" style="width: 20px" class="me-2"><small>Continuar con Google</small></button>
                        </div>
                    </div>
                </div>
            </div>
