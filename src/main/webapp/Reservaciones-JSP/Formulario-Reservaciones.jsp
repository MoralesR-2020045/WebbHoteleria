        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand" href="../index.jsp">
                    <img src="../Assets/Image/logo.png" alt="Imagen Logo" alt="Imagen Logo" style="height: 150px; width: 200px">
                </a>
        ...
        <div class="container mt-5">
            <form action="../../HotelMaquq/reservaciones-servlet" method="POST" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <script type="text/javascript">
                        $(function () {
                            $('#fechaDeIngreso').datepicker({
                                ...
                                $('#fechaDeIngreso').val(e.format(0, "yyyy-mm-dd"));
                            });
                        });
                    </script>
                    ...
                    <script type="text/javascript">
                        $(function () {
                            $('#fechaDeEgreso').datepicker({
                                autoclose: true,
                                format: 'yyyy-mm-dd'
                            }).on('changeDate', function (e) {
                                $('#fechaDeEgreso').val(e.format(0, "yyyy-mm-dd"));
                            });
                        });
                    </script>
