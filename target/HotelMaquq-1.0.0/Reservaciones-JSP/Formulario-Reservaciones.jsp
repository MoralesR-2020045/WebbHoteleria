            ...
            <div class="container mt-5">
                <form action="../../HotelMaquq/reservaciones-servlet" method="POST" enctype="multipart/form-data">
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="fechaDeIngreso" name="fechaDeIngreso"
                            placeholder="">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="estadoDeDisponibilidad"
                            name="estadoDeDisponibilidad" placeholder="">
                    ...
                    <div>
                        ...
                        <button class="btn btn-success" type="button" href="./reservaciones-servlet">Ver Datos</button>
                    </div>
                </form>
